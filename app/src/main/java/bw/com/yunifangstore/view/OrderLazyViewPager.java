 ...
 */
public class OrderLazyViewPager extends ViewGroup {
    ...
    public OrderLazyViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public OrderLazyViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
